...
namespace GameLauncher
{
    public class AdminWindow : EditorWindow
    {
        ...
        private const string WorkspaceLauncherFolderName = "GameLauncher Launcher Workspace";
        private const string WorkspaceAppFolderName = "GameLauncher App Workspace";
