...
namespace GameLauncher {
    ...
    public class Wizard : EditorWindow
    {
        ...
        public static void ShowWindow()
        {
            ...
            wizard.minSize = new Vector2(482, 576f);
        }
        ...
        void OnGUI()
        {
            ...
            GUILayout.BeginVertical (groupStyle);
            {
                ...
                GUILayout.Label ("Discord community and support", title2TextStyle);
                GUILayout.Label ("Join the discord community and get faster support!", normalLabel);
