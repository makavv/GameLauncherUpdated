...
namespace GameLauncher.Controls
{
    ...
    public partial class GameSettingsDropdown : UserControl
    {
        ...
        public void RefreshLanguage()
        {
            ...
            Option_Uninstall.Text = GameLauncherCore.Localization.Get (GameLauncherCore.LocalizationID.GameSettingsDropdown_Uninstall);
        }
        ...
        private void Uninstall_Click (object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            // Uninstall selected game
            MainWindow mainWindow = Application.Current.MainWindow as MainWindow;
            mainWindow.UninstallGame ();
